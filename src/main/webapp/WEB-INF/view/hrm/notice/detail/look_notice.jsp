 ...
 <script type="text/javascript" src="${ctx}/resources/tiny_mce/tiny_mce.js"></script>
		...
		tinyMCE.init({
			...
			$(function(){
				...
				var typeId = "${notice.noticeType.id}";
                  //异步加载公告类型信息  
				 $.ajax({
					  ...
					  success : function(data){
						  $.each(data, function(){
							  $("<option/>").val(this.id).html(this.type).attr("selected",typeId==this.id).appendTo("#noticeType");
						  })
