...
<body>
		<div class="container">
			<form id="addJobForm" style="padding: 30px;" class="form-horizontal" action="${ctx }/hrm/job/addJob.jspx" method="post">

				<div class="form-group">
					<div>
						<input id="name" name="name" type="text" class="form-control" placeholder="职位名称" />
					</div>
				</div>
