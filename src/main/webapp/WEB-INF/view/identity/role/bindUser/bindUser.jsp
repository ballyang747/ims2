...
<script type="text/javascript">
    $(function(){
    	...
    	$("#bindUser").click(function(){
    	 ...
    	 var checkboxs= $("input[id^='box_']:checked") 
    		
    		if(!checkboxs.length){
    			
    			$.messager.alert("提示信息","请选择绑定用户","error");
    		}else{
    			var arr=new Array();
    			...
    			window.location = "${ctx}/identity/role/bound.jspx?userId="+arr+"&id=${roleId}&pageIndex=${ pageModel.pageIndex}";
		...
		<!-- 工具按钮区 -->
 		...
 		<div class="panel panel-primary" style="padding-left: 5px;">
			...
			<div >
				...
				<ks:pager pageIndex="${ pageModel.pageIndex}" pageSize="${pageModel.pageSize}" totalNum="${pageModel.recordCount}" submitUrl="${ctx}/identity/role/selectRoleUser.jspx?pageIndex={0}&id=${roleId}" pageStyle="badoo"></ks:pager>
			</div>
